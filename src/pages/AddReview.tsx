...
const AddReview = () => {
  ...
  return (
    ...
    >
      <Card className="bg-gradient-to-br from-gray-900 via-gray-800 to-gray-900 border-gray-700 rounded-2xl">
        <CardHeader>
          <CardTitle className="text-2xl text-center text-gradient">Write a Review</CardTitle>
        </CardHeader>
        <CardContent>
